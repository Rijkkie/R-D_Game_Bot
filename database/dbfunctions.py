...
def get_balance(user_id):
    return retrieve_query(sqlQueries[4], (user_id,))[0]
...
def stats_rank(game, user_id):  # REMOVE
    values = {'game': game, 'user_id': user_id}
    count = retrieve_query(sqlQueries[6], values)[0][0]
